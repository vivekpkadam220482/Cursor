 ...
 * Usage: node scripts/run-with-api-key.js --apiKey=YOUR_API_KEY [test-command]
 * 
 * Examples:
 * - node scripts/run-with-api-key.js --apiKey=abc123 npm test
 * - node scripts/run-with-api-key.js --apiKey=abc123 npm run test:basic
 * - node scripts/run-with-api-key.js --apiKey=abc123 npx jest tests/basic-visual.test.ts
 */
